...
sleep 10s
#ejecutar 
docker exec -it entorno_spark-worker_1 /spark/bin/spark-submit --class prueba.TestingProject --deploy-mode client --master spark://spark-master:7077 --verbose --supervise /opt/spark-apps/Batch_Layer-assembly-0.1.0-SNAPSHOT.jar 

#Parar docker compose
docker-compose -f entorno/docker-compose.yml down
